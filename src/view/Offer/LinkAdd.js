        ...
        <Grid container spacing={4} sx={{ mt: 1 }}>
          <Grid item xs={12} md={6}>
            ...
            <FormControl>
              ...
              >
                <FormControlLabel value='female' control={<Radio />} label='バナー' />
                <FormControlLabel value='male' control={<Radio />} label='テキスト' />
              </RadioGroup>
            </FormControl>
          </Grid>
          <Grid item xs={12} md={6}>
            ...
            <CustomPaper>
              ...
              <FormControl>
                <RadioGroup
                  ...
                  name='row-radio-buttons-group'
                >
                  <FormControlLabel value='female' control={<Radio />} label='表示' />
        ...
        <Grid container spacing={4} sx={{ mt: 1 }}>
          <Grid item xs={12} md={6}>
            ...
            <List>
              <ListItem sx={{ p: 0 }}>
                <ListItemText
                  primary='※ファイルの容量：1ファイル合計で5MB以内'
                />
              </ListItem>
              <ListItem sx={{ p: 0 }}>
                <ListItemText
                  primary='※ファイルの種類：アップロードできるファイルの種類は「jpeg、jpg、png、gif」に限ります。'
                />
              </ListItem>
              <ListItem sx={{ p: 0 }}>
                <ListItemText
                  primary='※ファイルの推奨サイズは、縦 560 ピクセル、横 420 ピクセル、縦横比 4×3の比率です'
                />
              </ListItem>
            </List>
          </Grid>
